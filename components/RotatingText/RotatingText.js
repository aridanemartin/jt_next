    ...
    <>
      <div className={styles.rotatingText}>
        <div className={styles.textWrap}>
          <p className={styles.especialidadesTitle}>
            Si necesitas ayuda en alguna de las siguientes especialidades estás
          ...
          <div className={styles.especialidadesListWrapper}>
            <div className={styles.especialidadesList}>
              <h2 className={styles.item0}>
                Diabetes y Síndrome
                <br />
                Metabólico
              </h2>
              <h2 className={styles.item1}>
                Patología Tiroidea y<br /> Ecografía Tiroidea
              </h2>
              ...
              <h2 className={styles.item7}>Obesidad</h2>
        ...
        <Link href="/equipo" className={styles.buttonWrap}>
          Concertar Cita
        </Link>
      </div>
    </>
