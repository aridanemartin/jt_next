          ...
          <section className={styles.doctorBioWrap}>
            ...
            <div className={styles.socialWrapper}>
              ...
              {props.author.doctoralia && (
                <Link href={formatLink(props.author.doctoralia)}>
                  <a target="_blank" rel="noopener noreferrer">
                    <div className={styles.socialIcon}>
                      <Image
                        src={doctoraliaLogo}
              ...
              {props.author.instagram && (
                <Link href={formatLink(props.author.instagram)}>
                  <a target="_blank" rel="noopener noreferrer">
                    <div className={styles.socialIcon}>
                      <svg
                        fill="#000000"
              ...
              {props.author.youtube && (
                <Link href={formatLink(props.author.youtube)}>
                  <a target="_blank" rel="noopener noreferrer">
                    <div className={styles.socialIcon}>
                      <svg
                        fill="#000000"
              ...
              {props.author.twitter && (
                <Link href={formatLink(props.author.twitter)}>
                  <a target="_blank" rel="noopener noreferrer">
                    <div className={styles.socialIcon}>
                      <svg
                        fill="#000000"
              ...
              {props.author.facebook && (
                <Link href={formatLink(props.author.facebook)}>
                  <a target="_blank" rel="noopener noreferrer">
                    <div className={styles.socialIcon}>
                      <svg
                        fill="#000000"
              ...
              <a className={styles.servicesCardWrapper}>
                ...
                <div className={styles.servicesContentWrap}>
                  <div className={styles.servicesTitle}>
                    ...
                    {props.author.servicio1Duration && <p>{props.author.servicio1Duration} min</p>}
                  </div>
              ...
              <a className={styles.servicesCardWrapper}>
                ...
                <div className={styles.servicesContentWrap}>
                  <div className={styles.servicesTitle}>
                    ...
                    {props.author.servicio2Duration && <p>{props.author.servicio2Duration} min</p>}
                  </div>
                  <div className={styles.servicesDescription}>
                    <SanityBlockContent
              ...
              <a className={styles.servicesCardWrapper}>
                <div className={styles.servicesCard}>
                  ...
                  <div className={styles.servicesTitle}>
                    ...
                    {props.author.servicio3Duration && <p>{props.author.servicio3Duration} min</p>}
                  </div>
                  <div className={styles.servicesDescription}>
                    <SanityBlockContent
              ...
              <a className={styles.servicesCardWrapper}>
                <div className={styles.servicesCard}>
                  ...
                  <div className={styles.servicesTitle}>
                    ...
                    {props.author.servicio4Duration && <p>{props.author.servicio4Duration} min</p>}
                  </div>
                  <div className={styles.servicesDescription}>
                    <SanityBlockContent
              ...
              <a className={styles.servicesCardWrapper}>
                <div className={styles.servicesCard}>
                  ...
                  <div className={styles.servicesTitle}>
                    ...
                    {props.author.servicio5Duration && <p>{props.author.servicio5Duration} min</p>}
                  </div>
                  <div className={styles.servicesDescription}>
                    <SanityBlockContent
