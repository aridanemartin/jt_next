...
export default function AvisoLegal() {
  return (
    <>
      <Meta
        title="Dr. Julián Tamayo | Aviso Legal"
        desc="Sección legal | Julián Tamayo | Endocrino especialista en el cuidado de enfermedades crónicas."
        canonical="https://www.juliantamayo.com/legal/aviso-legal"
      ...
      <Layout>
        <div className={styles.legalText}>
          <h2 className={styles.legalTextTitle}>AVISO LEGAL</h2>
          <h2>INTRODUCCIÓN</h2>
          <p>
            ...
            la condición de usuario del mismo e implica la aceptación de todas
            las condiciones incluidas en el presente aviso Legal. El usuario se
          ...
          <p>
            ...
            adelante contenidos pertenecientes a JULIAN ANDRES TAMAYO SERRATO ,
            o a sus licenciadores, a los que la usuaria o el usuario pueda tener
          ...
          <p>
            JULIAN ANDRES TAMAYO SERRATO, por sí o como cesionaria, es titular
            de todos los derechos de propiedad intelectual e industrial de su
            ...
            técnico, sin la autorización de JULIAN ANDRES TAMAYO SERRATO . En
            ningún momento, salvo manifestación expresa de lo contrario, el
            acceso, navegación o utilización del sitio Web o de sus contenidos
            confiere a la usuaria o al usuario derecho alguno sobre signos
            distintivos en él incluidos. La usuaria o el usuario se compromete a
            respetar los derechos de Propiedad Intelectual e Industrial
            titularidad de JULIAN ANDRES TAMAYO SERRATO En el caso de que la
            usuaria o el usuario envíe información de cualquier tipo a JULIAN
            ANDRES TAMAYO SERRATO a través de cualquiera de los canales
          ...
          <p>
            ...
            por terceras personas. JULIAN ANDRES TAMAYO SERRATO no responde de
            la veracidad y exactitud de los mismos, quedando exenta de cualquier
            responsabilidad con los usuarios y con las usuarias que hagan uso de
            ellos. JULIAN ANDRES TAMAYO SERRATO se reserva el derecho de
            modificar el contenido del Sitio sin previo aviso y sin ningún tipo
            de limitación. Así mismo, la empresa declina cualquier
            responsabilidad por los eventuales daños y perjuicios que puedan
            ocasionarse por la falta de disponibilidad o continuidad de este
            sitio y de los servicios que se ofrecen en él. Tampoco podemos
            garantizar la ausencia de virus ni de otros elementos en la Web que
            puedan producir alteraciones en su sistema informático. JULIAN
            ANDRES TAMAYO SERRATO declina cualquier responsabilidad por los
            ...
            mismo, los Usuarios/as que remitan cualquier tipo de información a
            se asegurarán de que la misma sea veraz y de que no vulnere
            cualquier derecho de terceras personas ni la legalidad vigente. Si
            Ud. cree que cualquier contenido o información de este Sitio vulnera
            un derecho legítimo o la legalidad vigente le estaríamos muy
          ...
          <p>
            ...
            de Internet JULIAN ANDRES TAMAYO SERRATO no ejercerá ningún tipo de
            ...
            usuario reconoce y acepta que JULIAN ANDRES TAMAYO SERRATO no será
          ...
          <p>
            JULIAN ANDRES TAMAYO SERRATO se reserva el derecho a denegar o
            retirar el acceso a portal o a los servicios ofrecidos sin necesidad
            de preaviso, a instancia propia o de terceras personas, a aquellos
          ...
          <p>
            ...
            usuario se regirá por la normativa española vigente. Y siempre que
            la normativa vigente al efecto establezca la posibilidad para las
